...
import 'leader_detail_post.dart';

class LeaderSearchPost extends StatefulWidget {
  const LeaderSearchPost({Key? key}) : super(key: key);

  @override
  State<LeaderSearchPost> createState() => _LeaderSearchPostState();
}

class _LeaderSearchPostState extends State<LeaderSearchPost> {
  List searchResult = [];
  String name = '';
                          ...
                          if (data['content']
                            ...
                            return InkWell(
                              onTap: () {
                                ...
                                Navigator.push(context, MaterialPageRoute(builder: (context) => LeaderDetailPost(newFeedModel: newFeedModel,)));
                              },
                              child: ListTile(
